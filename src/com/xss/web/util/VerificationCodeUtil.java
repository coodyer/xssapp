...
public class VerificationCodeUtil {
	 ...
	 */
	public BufferedImage outCode(int imgWidth, int imgHeight, int codeLenth,
	...
	// 初始化所需對象
	private void getConn(int width, int height) {
		if (rnad == null) {
			rnad = new Random();
		}
		if (baseImg == null) {
	...
	// 獲取驗證碼字符串
	public String getCodeStr(int codeLenth) {
		if (rnad == null) {
			rnad = new Random();
		}
	...
	private BufferedImage getBaseImg(int width, int height) {
