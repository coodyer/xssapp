...
<head>
<meta charset="utf-8">
<meta name="baidu-site-verification" content="7ADWcBdcPF" />
				...
				<div class="col-lg-5 col-sm-6">
					...
					<p class="lead">
						Prower By <a target="_blank"
							href="http://user.qzone.qq.com/644556636">Scrum</a>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
					...
					<p class="lead">
						其实 <a target="_blank" href="http://user.qzone.qq.com/644556636">Scrum团队</a>根本不会技术,
