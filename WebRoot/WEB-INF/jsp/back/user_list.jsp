		...
		<div class="admin-content">
			...
			<div class="am-panel am-panel-default">
				<div class="am-panel-hd am-cf"
					...
					用户列表<span class="am-icon-chevron-down am-fr" style="display: none"></span>
				</div>
				<div id="collapse-panel-base" class="am-panel-bd am-collapse am-in">
					<ul class="am-list am-list-static am-list-border">
						<li><span class="nowrap">
								...
								<div class="am-panel-bd">
											用户名:<input name="userName" class="am-form-input  am-radius"
											type="email" style="width: auto;display: -webkit-inline-box"
											value="${userName }" />&nbsp;&nbsp;邮箱：<input name="email" type="text"
											class="am-form-input  am-radius"
											style="width: auto;display: -webkit-inline-box"
											value="${email }" />&nbsp;&nbsp;手机号：<input name="mobile" type=text
											class="am-form-input  am-radius"
											style="width: auto;display: -webkit-inline-box"
											value="${mobile }" /><a href="javascript:indexPage()"
					...
					<table class="am-table am-table-bordered">
						...
						<c:if test="${empty pager.pageData}"><tr><td  colspan="6" style="text-align:center ">暂无数据</td></tr></c:if>
							<c:forEach items="${pager.pageData }" var="user">
								<tr>
									<td>${user.id }</td>
									<td>${user.userName }</td>
									<td>${user.mobile}</td>
									...
									<td><a
										href="${basePath }admin/userEdit.${defSuffix}?id=${user.id }">编辑</a>
										<a href="#" onclick="delDate(${user.id })">删除</a></td>
								</tr>
							</c:forEach>
						</tbody>
						<thead>
