...
<body>
	<div id="adminwindow"
		...
		<div
			style="width:533px;height:248px;margin:160px auto;background:url(${basePath }assets/images/loginbg.gif)">
			<form action="" method="post" id="loginForm" name="loginForm"
				onsubmit="return false;">
				<table width="90%" height="248" border="0" align="center">
					<tr>
						<td width="155" align="right" style="padding-right:30px"><img
							src="${basePath }assets/images/2.png" width="103" height="114"></td>
										...
										<table border="0" cellspacing="0" cellpadding="0" height="20">
											<tr>
												...
												<td style="padding:0px 3px"><img onclick="refVerCode()"
													id="currVerCode" src="${basePath }VerificationServlet"
													width="60" height="18"
...
<script src="${basePath }assets/js/validform.min.js"></script>
		...
		$
				.ajax({
					...
					success : function(json) {
						...
						if (json.code == 0) {
							$("#notice").html("");
							window.location.href = '${basePath }admin/index.${defSuffix}';
						} else {
							$("#ImgCode").val("");
							refVerCode();
						}
